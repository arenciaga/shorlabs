...
export function MobileServiceGrid({ services, projectId, onSelectService }: MobileServiceGridProps) {
    return (
        <div className="px-4 py-4 space-y-3">
            {services.map((service) => {
                ...
                return (
                    <Card
                        ...
                        className="gap-0 p-0 rounded-none cursor-pointer hover:border-zinc-400 hover:shadow-md transition-all group"
                    >
            ...
            <Link href={`/new?project_id=${projectId}`} className="block">
                <Button
                    variant="outline"
                    className="w-full rounded-none border-dashed h-auto py-4 flex-col gap-1"
                >
