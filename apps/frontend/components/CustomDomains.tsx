                                                            ...
                                                            {isApexDomain ? (
                                                                <>
                                                                    <div className="bg-amber-100 border border-amber-200 rounded-lg p-2.5 mb-3">
                                                                        <p className="text-xs font-semibold text-amber-900 mb-1">⚠️ Apex Domain Detected</p>
                                                                        <p className="text-xs text-amber-800 leading-relaxed mb-2">
                                                                            Most DNS providers (like GoDaddy) don't allow CNAME records for apex domains ({d.domain}). 
                                                                            Instead, add <span className="font-mono font-semibold">www.{d.domain}</span> as a CNAME, then forward {d.domain} to www.{d.domain}.
                                                                        </p>
                                                                    </div>
                                                                    ...
                                                                    <p className="text-xs text-amber-700 mb-3">
                                                                        <strong>Step 2:</strong> Set up domain forwarding from {d.domain} to www.{d.domain} in your DNS provider's settings (usually under "Domain Forwarding" or "URL Redirect").
                                                                    </p>
                                                                </>
                                                            ) : (
                                                                <p className="text-xs text-amber-700 mb-3">
